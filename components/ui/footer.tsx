    ...
    <footer>
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {/* Top area: Blocks */}
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12 flex justify-between">
            ...
            {/* 2nd block */}
            <div className="md:col-span-8 lg:col-span-7 justify-self-end">
              <h6 className="text-gray-200 font-medium mb-1">Contacto</h6>
              <ul>
                <li className="mb-1">
                  <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">asesorias@phymath.com</Link>
                </li>
                <li className="mb-1">
                  <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">+57 3001234567</Link>
                </li>
                <li className="mb-1">
                  <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Carrera 34 #14-15 Oficina 2</Link>
                </li>
              </ul>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; PhyMath.com. Todos los derechos son reservados.</div>
